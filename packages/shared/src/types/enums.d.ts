...
export declare enum FacilityAssetType {
 ...
 */
export declare enum AiDetectionMethod {
 ...
 * - 점검 일정 생성:     90% 자동화
 */
export declare enum RpaTaskType {
    ...
    MILEAGE_GRANT = "MILEAGE_GRANT"
}
export declare enum RpaTaskStatus {
    PENDING = "PENDING",
    RUNNING = "RUNNING",
    COMPLETED = "COMPLETED",
    FAILED = "FAILED",
...
/** 리스크 계산 대상 유형 */
export declare enum RiskTargetType {
    ASSET = "ASSET",// 시설물 자산
    ZONE = "ZONE",// 구역
...
/** 센서 측정값 품질 등급 */
export declare enum SensorReadingQuality {
    GOOD = "GOOD",// 정상 수신
...
/** 자동화 룰 카테고리 */
export declare enum AutomationRuleCategory {
