import { CrackRoi, CrackCalibrationParams, CrackCvAnalysisRaw, CrackConfidenceBreakdown, CrackManualCorrection } from '../cv/crack-analysis-types';
export declare enum CrackAnalysisStatus {
...
export declare enum CrackAnalysisReviewStatus {
