// packages/shared/src/jobs/job-payloads.ts
...
export type JobPayload =
  | AiImageAnalysisPayload
  | DroneVideoAnalysisPayload
  | CrackWidthMeasurementPayload
  | ReportGenerationPayload
  | RpaBillGenerationPayload
  | RpaContractExpiryPayload
  | RpaComplaintIntakePayload
  | ScheduleAutoGeneratePayload
  | VideoFrameExtractionPayload
  | ImageMetadataExtractionPayload
  | DefectDetectionPayload
  | CrackAnalysisPayload
  | DiagnosisOpinionPayload
  | ComplaintTriagePayload
  | RiskScoreCalculatePayload
  | MaintenanceRecommendPayload
