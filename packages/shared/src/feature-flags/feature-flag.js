...
exports.DEFAULT_FEATURE_FLAGS = exports.FeatureFlagKey = void 0;
var FeatureFlagKey;
(function (FeatureFlagKey) {
    FeatureFlagKey["PHASE2_AI"] = "phase2.ai";
    FeatureFlagKey["PHASE2_RPA"] = "phase2.rpa";
    FeatureFlagKey["PHASE2_IOT"] = "phase2.iot";
    FeatureFlagKey["PHASE2_DRONE"] = "phase2.drone";
    FeatureFlagKey["PHASE2_DIGITAL_TWIN"] = "phase2.digital_twin";
    FeatureFlagKey["AI_AUTO_ACCEPT"] = "ai.auto_accept";
    FeatureFlagKey["AI_DEFECT_DETECTION"] = "ai.defect_detection";
    FeatureFlagKey["AI_CRACK_ANALYSIS"] = "ai.crack_analysis";
    FeatureFlagKey["AI_DIAGNOSIS_OPINION"] = "ai.diagnosis_opinion";
    FeatureFlagKey["AI_COMPLAINT_TRIAGE"] = "ai.complaint_triage";
    FeatureFlagKey["RPA_DRY_RUN"] = "rpa.dry_run";
})(FeatureFlagKey || (exports.FeatureFlagKey = FeatureFlagKey = {}));
